  ...
  if (!plant) {
    return (
      <main className="min-h-screen flex flex-col items-center justify-center gap-4">
        ...
        <Link
          href="/items"
          className="text-sm text-green-600 hover:text-(--primary-hover) border border-green-300 px-5 py-2 rounded-full transition-colors duration-200"
        >
          Back to Plants
        </Link>
      </main>
  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <Link
          href="/items"
          className="inline-flex items-center gap-2 text-sm text-green-600 hover:text-(--primary-hover) mb-10 transition-colors duration-200 group"
        >
          <FiArrowLeft
            size={16}
